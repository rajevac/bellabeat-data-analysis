...
```{r}
write.csv(df_sleap_activity_day,'~/Learning/Data\ Analytics/Google\ Coursera\ Data\ Analytics\ Course/7_Capstone/bellabeat-data-analysis/clean-data/df_sleap_activity_day.csv', row.names = TRUE)
```
